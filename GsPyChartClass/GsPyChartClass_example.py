...
# fTableM = [-0.8, 0.2, 1.0, 2.3, 3.3, 4.2, 5.3, 6.3, 7.4, 8.4, 9.0]

fTable = [2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 12.5]
fTableM = [2.3, 3.3, 4.2, 5.3, 6.3, 7.4, 8.4, 9.4, 10.4, 11.4, 12.4]
...
a = GsPyMyChart(fInTableRef=fTable, fInTableMeas=fTableM, strPathPDF="Liniowy_wymiarowany.pdf",
                ...
                iLeft=100, iTop=200, iWidth=300, iHeight=400)

b = GsPyMyChart(fInTableRef=fTable, fInTableMeas=fTableM, strTitle=stringTitle, strPathPDF="Liniowy_maksymalny.pdf")

c = GsPyMyChartBar(fInTableRef=fTable, fInTableMeas=fTableM, strPathPDF="Słupkowy_wymiarowany.pdf",
				strTitle=stringTitle,
                iLeft=100, iTop=200, iWidth=300, iHeight=400)

d = GsPyMyChartBar(fInTableRef=fTable, fInTableMeas=fTableM, strTitle=stringTitle, strPathPDF="Słupkowy_maksymalny.pdf")
