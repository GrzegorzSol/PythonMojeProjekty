...
from GsPyMyChart import GsPyMyChart
...
b = GsPyMyChart(fInTableRef=fTable, fInTableMeas=fTableM, strTitle="Wykres słupkowy błędów dla aparatu:", strPathPDF="Liniowy_maksymalny.pdf")